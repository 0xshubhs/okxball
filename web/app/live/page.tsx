  ...
  useEffect(() => {
    const tick = setInterval(() => {
      ...
      if (Math.random() < 0.45 && starters.length) {
        ...
        idRef.current += 1;
        setEvents((e) => [
          { id: idRef.current, minute: Math.min(90, minute + 1), player: p, type, points: finalPts },
          ...e,
        ]);
    ...
    <div className="py-6">
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="chip border-neon/20 bg-neon/5 text-neon">
          <Radio className="h-3.5 w-3.5" /> Oracle scoring feed connected
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div className="glass relative overflow-hidden p-5">
            ...
            <p className="mt-1 text-xs text-white/50">
              Live winnings settle through OKX DEX liquidity, straight to your OKX
              Wallet on X Layer.
            </p>
            ...
            <p className="mt-2 text-center text-[11px] text-white/35">
              payoutVault.claim(leagueId) · simulated tx
            </p>
          </div>
