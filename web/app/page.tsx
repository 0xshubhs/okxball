...
import { GAMEWEEK, PLAYERS, PRIZE_POOL_OKB } from "@/lib/data";
...
const FEATURES = [
  ...
  },
  {
    ...
    body: "Matchday stats stream in via oracles. Watch points tick live, gameweek after gameweek, fully on-chain.",
    color: "#2dd4ff",
  },
  {
    icon: Coins,
    title: "Instant OKB payouts",
    body: "Win and get paid the same minute — prize splits settle through OKX DEX liquidity straight to your wallet.",
    color: "#ffd35c",
  },
];
    ...
    <div className="relative">
      ...
      <section className="grid items-center gap-10 py-10 lg:grid-cols-[1.1fr_0.9fr] lg:py-16">
        <div>
          ...
          >
            <Zap className="h-3.5 w-3.5" /> Built on X Layer · powered by OKX Wallet
          </motion.div>
          ...
          >
            Agentic Fantasy Football OS turns football into a GameFi league. Mint
            Player NFTs, let AI agents auto-manage your team from real match
            stats, and get paid in OKB the moment the whistle blows.
          </motion.p>
          ...
          <div className="mt-10 grid max-w-md grid-cols-3 gap-4">
            ...
            <Stat value={`GW ${GAMEWEEK}`} label="Live gameweek" />
        ...
        <div className="relative h-[420px]">
          ...
          >
            <PlayerCard player={hero2} size="sm" />
          </motion.div>
          <motion.div
          ...
          >
            <PlayerCard player={hero3} size="sm" />
          </motion.div>
          <div className="absolute left-1/2 top-1/2 -z-10 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-neon/20 blur-[100px]" />
        </div>
      </section>
