/**
 * Mock domain data for the Agentic Fantasy Football OS demo.
 *
...
export const PLAYERS: Player[] = [
  // Forwards
  {
    id: "p1", tokenId: 1, name: "Kaze Mbala", club: "Arsenal FC", country: "France", flag: "🇫🇷",
    position: "FWD", rating: 94, rarity: "icon", level: 7, xp: 320, xpToNext: 500, form: 9,
    price: 4.2, fixtureOpponent: "BUR", fixtureDifficulty: 2, owned: true, accent: "#ff4d8d",
    stats: mkStats({ pace: 96, shooting: 93, passing: 82, defending: 38, physical: 78 }),
  },
  {
    id: "p2", tokenId: 2, name: "Leo Sterling", club: "Man City", country: "England", flag: "🏴",
    position: "FWD", rating: 90, rarity: "legendary", level: 5, xp: 180, xpToNext: 400, form: 8,
    price: 3.4, fixtureOpponent: "EVE", fixtureDifficulty: 2, owned: true, accent: "#ffd35c",
    stats: mkStats({ pace: 90, shooting: 89, passing: 84, defending: 40, physical: 75 }),
  },
  {
    id: "p3", tokenId: 3, name: "Diego Sol", club: "Real Madrid", country: "Spain", flag: "🇪🇸",
    position: "FWD", rating: 88, rarity: "epic", level: 4, xp: 90, xpToNext: 350, form: 7,
    price: 2.8, fixtureOpponent: "GIR", fixtureDifficulty: 3, owned: false, accent: "#ff4d8d",
    stats: mkStats({ pace: 88, shooting: 87, passing: 80, defending: 35, physical: 80 }),
  },
  {
    id: "p4", tokenId: 4, name: "Tariq Bello", club: "Napoli", country: "Nigeria", flag: "🇳🇬",
    position: "FWD", rating: 85, rarity: "rare", level: 3, xp: 220, xpToNext: 300, form: 8,
    price: 2.1, fixtureOpponent: "LAZ", fixtureDifficulty: 3, owned: false, accent: "#2dd4ff",
    stats: mkStats({ pace: 91, shooting: 83, passing: 76, defending: 42, physical: 84 }),
  },
  {
    id: "p5", tokenId: 5, name: "Noah Frost", club: "Dortmund", country: "Germany", flag: "🇩🇪",
    position: "FWD", rating: 83, rarity: "common", level: 2, xp: 60, xpToNext: 250, form: 6,
    price: 1.4, fixtureOpponent: "RBL", fixtureDifficulty: 4, owned: false, accent: "#ffffff",
    stats: mkStats({ pace: 85, shooting: 82, passing: 74, defending: 38, physical: 79 }),
  },
  // Midfielders
  {
    id: "p6", tokenId: 6, name: "Marco Vento", club: "Inter Milan", country: "Italy", flag: "🇮🇹",
    position: "MID", rating: 91, rarity: "legendary", level: 6, xp: 410, xpToNext: 450, form: 9,
    price: 3.6, fixtureOpponent: "TOR", fixtureDifficulty: 2, owned: true, accent: "#ffd35c",
    stats: mkStats({ pace: 78, shooting: 84, passing: 93, defending: 72, physical: 80 }),
  },
  {
    id: "p7", tokenId: 7, name: "Ayo Carter", club: "Liverpool", country: "England", flag: "🏴",
    position: "MID", rating: 89, rarity: "epic", level: 5, xp: 300, xpToNext: 400, form: 8,
    price: 3.0, fixtureOpponent: "WHU", fixtureDifficulty: 3, owned: true, accent: "#ff4d8d",
    stats: mkStats({ pace: 82, shooting: 80, passing: 90, defending: 78, physical: 82 }),
  },
  {
    id: "p8", tokenId: 8, name: "Hiro Tanaka", club: "Bayern", country: "Japan", flag: "🇯🇵",
    position: "MID", rating: 87, rarity: "epic", level: 4, xp: 140, xpToNext: 350, form: 7,
    price: 2.6, fixtureOpponent: "FRE", fixtureDifficulty: 2, owned: false, accent: "#ff4d8d",
    stats: mkStats({ pace: 80, shooting: 78, passing: 89, defending: 74, physical: 76 }),
  },
  {
    id: "p9", tokenId: 9, name: "Sam Okoro", club: "Chelsea", country: "Nigeria", flag: "🇳🇬",
    position: "MID", rating: 84, rarity: "rare", level: 3, xp: 110, xpToNext: 300, form: 7,
    price: 1.9, fixtureOpponent: "BHA", fixtureDifficulty: 3, owned: true, accent: "#2dd4ff",
    stats: mkStats({ pace: 83, shooting: 76, passing: 85, defending: 70, physical: 81 }),
  },
  {
    id: "p10", tokenId: 10, name: "Luca Ferri", club: "Juventus", country: "Italy", flag: "🇮🇹",
    position: "MID", rating: 82, rarity: "common", level: 2, xp: 40, xpToNext: 250, form: 6,
    price: 1.3, fixtureOpponent: "ROM", fixtureDifficulty: 4, owned: false, accent: "#ffffff",
    stats: mkStats({ pace: 76, shooting: 74, passing: 84, defending: 73, physical: 78 }),
  },
  // Defenders
  {
    id: "p11", tokenId: 11, name: "Theo Vance", club: "Real Madrid", country: "France", flag: "🇫🇷",
    position: "DEF", rating: 90, rarity: "legendary", level: 5, xp: 250, xpToNext: 400, form: 8,
    price: 2.9, fixtureOpponent: "GIR", fixtureDifficulty: 3, owned: true, accent: "#ffd35c",
    stats: mkStats({ pace: 84, shooting: 55, passing: 80, defending: 91, physical: 88 }),
  },
  {
    id: "p12", tokenId: 12, name: "Kwame Mensah", club: "Arsenal FC", country: "Ghana", flag: "🇬🇭",
    position: "DEF", rating: 87, rarity: "epic", level: 4, xp: 160, xpToNext: 350, form: 8,
    price: 2.4, fixtureOpponent: "BUR", fixtureDifficulty: 2, owned: true, accent: "#ff4d8d",
    stats: mkStats({ pace: 86, shooting: 48, passing: 78, defending: 88, physical: 86 }),
  },
  {
    id: "p13", tokenId: 13, name: "Erik Holm", club: "Man City", country: "Sweden", flag: "🇸🇪",
    position: "DEF", rating: 85, rarity: "rare", level: 3, xp: 130, xpToNext: 300, form: 7,
    price: 2.0, fixtureOpponent: "EVE", fixtureDifficulty: 2, owned: true, accent: "#2dd4ff",
    stats: mkStats({ pace: 79, shooting: 45, passing: 82, defending: 86, physical: 84 }),
  },
  {
    id: "p14", tokenId: 14, name: "Pablo Cruz", club: "Barcelona", country: "Spain", flag: "🇪🇸",
    position: "DEF", rating: 84, rarity: "rare", level: 3, xp: 90, xpToNext: 300, form: 6,
    price: 1.8, fixtureOpponent: "SEV", fixtureDifficulty: 3, owned: false, accent: "#2dd4ff",
    stats: mkStats({ pace: 80, shooting: 50, passing: 84, defending: 84, physical: 80 }),
  },
  {
    id: "p15", tokenId: 15, name: "Jonas Reed", club: "Newcastle", country: "England", flag: "🏴",
    position: "DEF", rating: 81, rarity: "common", level: 2, xp: 30, xpToNext: 250, form: 6,
    price: 1.2, fixtureOpponent: "AVL", fixtureDifficulty: 4, owned: false, accent: "#ffffff",
    stats: mkStats({ pace: 77, shooting: 42, passing: 75, defending: 83, physical: 85 }),
  },
  {
    id: "p16", tokenId: 16, name: "Andrei Pop", club: "Inter Milan", country: "Romania", flag: "🇷🇴",
    position: "DEF", rating: 83, rarity: "rare", level: 3, xp: 75, xpToNext: 300, form: 7,
    price: 1.7, fixtureOpponent: "TOR", fixtureDifficulty: 2, owned: false, accent: "#2dd4ff",
    stats: mkStats({ pace: 78, shooting: 44, passing: 79, defending: 85, physical: 83 }),
  },
  // Goalkeepers
  {
    id: "p17", tokenId: 17, name: "Viktor Stahl", club: "Bayern", country: "Germany", flag: "🇩🇪",
    position: "GK", rating: 90, rarity: "legendary", level: 5, xp: 280, xpToNext: 400, form: 9,
    price: 2.7, fixtureOpponent: "FRE", fixtureDifficulty: 2, owned: true, accent: "#ffd35c",
    stats: mkStats({ pace: 58, shooting: 30, passing: 76, defending: 92, physical: 86 }),
  },
  {
    id: "p18", tokenId: 18, name: "Rui Costa", club: "Benfica", country: "Portugal", flag: "🇵🇹",
    position: "GK", rating: 85, rarity: "epic", level: 4, xp: 120, xpToNext: 350, form: 7,
    price: 1.9, fixtureOpponent: "POR", fixtureDifficulty: 3, owned: false, accent: "#ff4d8d",
    stats: mkStats({ pace: 55, shooting: 28, passing: 72, defending: 87, physical: 82 }),
  },
  {
    id: "p19", tokenId: 19, name: "Iker Mendez", club: "Sevilla", country: "Spain", flag: "🇪🇸",
    position: "GK", rating: 82, rarity: "common", level: 2, xp: 50, xpToNext: 250, form: 6,
    price: 1.1, fixtureOpponent: "BAR", fixtureDifficulty: 5, owned: false, accent: "#ffffff",
...
export const FIXTURES: Fixture[] = [
  { id: "f1", home: "ARS", away: "BUR", kickoff: "Sat 12:30", status: "live", minute: 67, homeScore: 2, awayScore: 0 },
  { id: "f2", home: "MCI", away: "EVE", kickoff: "Sat 15:00", status: "live", minute: 54, homeScore: 1, awayScore: 1 },
  { id: "f3", home: "INT", away: "TOR", kickoff: "Sat 17:30", status: "upcoming" },
  { id: "f4", home: "RMA", away: "GIR", kickoff: "Sun 16:15", status: "upcoming" },
  { id: "f5", home: "BAY", away: "FRE", kickoff: "Sun 18:30", status: "upcoming" },
];
